...
@router.get("/list_related_agencies/{excursion_id}")
async def list_related_agencies(excursion_id: int, db: Session = Depends(get_db)):
    return crud.list_related_agencies(db, excursion_id)
