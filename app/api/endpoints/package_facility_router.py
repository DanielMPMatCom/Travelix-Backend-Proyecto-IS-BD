...
async def delete_package_facility(package_facility_delete: PackageFacilityAssociationSchema, db: Session = Depends(get_db)):
    return crud.delete_package_facility(db, package_facility_delete)
